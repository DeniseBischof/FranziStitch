...
export const COPY = {
  de: {
    openProject: "Projekt öffnen", saveProject: "Projekt speichern",
    kicker: "AUTO-DIGITALISIERER · VERSION 2", headlineA: "Vom Motiv zur", headlineB: "sauberen Stickdatei.",
    intro: "Unterlage, Zugausgleich, Satin, Stoffprofile und Qualitätsprüfung für direkt nutzbare Maschinenformate.",
    featureObject: "Objektbasiert", featureFabric: "Stoffprofile", featureDst: "DST · EXP · JEF",
    motif: "MOTIV", sourceProject: "Quelle & Projekt", svgFile: "SVG-Datei", lettering: "Schriftzug",
    dropTitle: "SVG hier ablegen", dropMeta: "Maximal 5 MB · SVG-Vektordatei", examples: "ODER BEISPIEL AUSWÄHLEN",
    ...
    quality: "QUALITÄTSPRÜFUNG", notices: "Hinweise", noIssues: "Keine Qualitätsprobleme erkannt.", filename: "Dateiname", format: "Dateiformat", download: "Stickdatei herunterladen",
    machineHint: "Das Maschinen-Preset wählt Format und Schnittverhalten. Bitte den tatsächlichen Rahmen deiner Maschine prüfen.",
    formatDst: "DST – universell / Tajima", formatExp: "EXP – Melco", formatJef: "JEF – Janome / Elna",
    footer: "Automatische Digitalisierung bleibt eine Ausgangsbasis. Vor Produktion immer probesticken.", privacy: "Verarbeitung im Browser · keine Uploads",
    ...
    fabricWoven: "Webware", fabricStretch: "Dehnbarer Stoff", fabricTerry: "Frottee", machineGeneric: "Universal / Tajima", machineTrim: "Universal / Tajima mit Schnittfolge", machineMelco: "Melco", machineJanome: "Janome / Elna",
  },
  en: {
    openProject: "Open project", saveProject: "Save project",
    kicker: "AUTO-DIGITIZER · VERSION 2", headlineA: "From artwork to a", headlineB: "clean stitch file.",
    intro: "Underlay, pull compensation, satin, fabric profiles and quality checks for machine-ready formats.",
    featureObject: "Object-based", featureFabric: "Fabric profiles", featureDst: "DST · EXP · JEF",
    motif: "DESIGN", sourceProject: "Source & project", svgFile: "SVG file", lettering: "Lettering",
    dropTitle: "Drop SVG here", dropMeta: "Up to 5 MB · SVG vector file", examples: "OR PICK AN EXAMPLE",
    ...
    quality: "QUALITY CHECK", notices: "notices", noIssues: "No quality issues detected.", filename: "File name", format: "File format", download: "Download stitch file",
    machineHint: "The machine preset selects format and trim behavior. Please verify the actual hoop on your machine.",
    formatDst: "DST – universal / Tajima", formatExp: "EXP – Melco", formatJef: "JEF – Janome / Elna",
    footer: "Automatic digitizing is a starting point. Always run a test sew before production.", privacy: "Processed in your browser · no uploads",
    ...
    fabricWoven: "Woven fabric", fabricStretch: "Stretch fabric", fabricTerry: "Terry cloth", machineGeneric: "Universal / Tajima", machineTrim: "Universal / Tajima with trim sequence", machineMelco: "Melco", machineJanome: "Janome / Elna",
  },
} as const;
